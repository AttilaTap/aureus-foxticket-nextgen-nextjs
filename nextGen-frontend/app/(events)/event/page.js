...
export default function Event() {
  return (
    <div className="w-2/3">
      <div className="flex justify-center mx-auto -mt-20 mb-36 w-3/4 h-80 rounded-md bg-[url('../public/background-img/bg-image-event-one.jpg')] bg-cover bg-center ">
        <div className="w-full justify-center">
          <h1 className="text-4xl font-bold mt-80 pt-9 text-center">
            The best Event in the History
          </h1>
          <div className="flex flex-row space-x-1 justify-center pt-3">
            <svg
              width="17px"
              height="17px"
              viewBox="-5 0 28.80 28.80"
              fill="none"
      ...
      <div>
        ...
        <div className="flex flex-row space-x-2 pb-10">
          ...
          <span className="text-base text-emerald-400 font-bold">20 sold</span>
          <svg
            fill="#000000"
            width="15px"
            height="15px"
      ...
      <div className="w-full pb-12">
        ...
        <div className="card">
          ...
          <div className="w-44 p-1 flex flex-row justify-end items-center">
            <span className="font-bold pr-3">€50.10 / ticket</span>
          </div>
        </div>
      </div>
    </div>
