...
const Login = ({ isVisible, onCloseLog, openReg }) => {
  ...
  return (
    <div className="fixed inset-0 backdrop-blur-sm flex justify-center items-center z-10" id="wrapper" onClick={handleClose}>
      <div className="flex flex-col justify-center items-center w-1/3 h-auto relative  rounded-lg bg-stone-400">
        ...
        <h2 className="px-2 text-2xl font-bold text-center mt-2 mb-3 text-stone-950">Log in and find your NEXTicket</h2>
        ...
        <form className="px-8 pt-6">
          ...
          <div className="flex items-center justify-between gap-2 mt-8">
            ...
            <div className="flex flex-col mb-3 lg:items-end">
              <Link className="font-bold text-m text-sky-700 hover:text-sky-800 cursor-pointer" href="">
                Forgot Password?
              </Link>
              <p className="font-bold text-m text-stone-700">Not a member yet?</p>
              <Link
