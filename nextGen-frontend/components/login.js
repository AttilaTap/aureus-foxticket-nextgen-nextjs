      ...
      <div className="flex flex-col justify-center items-center w-1/2 lg:w-1/3 sm:min-w-fit h-auto relative  rounded-lg bg-stone-400">
        ...
        <form className="px-8 pt-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between gap-2 mt-4 ">
            <button
              className="bg-sky-700 hover:bg-sky-800 text-stone-100 font-bold p-4 rounded-lg md:w-24 md:h-15 focus:outline-none focus:shadow-outline"
              type="submit"
            >
              Sign In
            </button>
            ...
            <div>
              <button
                ...
                className="flex items-center gap-2 bg-white shadow-xl rounded-lg pl-3 ml-4 mr-4 md:w-38 md:h-15"
              >
                <Image src="/img/google-logo.png" height={20} width={20} />
                <span className="bg-sky-700 text-stone-100 font-bold rounded-lg p-4 md:w-52 md:h-15">
