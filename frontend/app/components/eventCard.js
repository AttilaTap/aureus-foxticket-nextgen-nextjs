const EventCard = ({ dateFromDb, eventName, eventLocation, eventDescription, availableTickets }) => {
  ...
  return (
    <div className="card bg-gray-800">
      ...
      <div className="m-4 w-full">
        ...
        <span className="block text-black-500 text-sm">{eventDescription}</span>
      </div>
      <div className="w-44 p-1 flex flex-row justify-end items-center">
        <span className="pr-2">{availableTickets}</span>
        <svg className="hover:fill-amber-500" fill="#5dd9a7" width="40px" height="40px" viewBox="0 -4 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg">
          <title>ticket</title>
